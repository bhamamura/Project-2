...
Banana.prototype.type = "lava"

function Falling(pos, ch) {
  this.pos = pos;
  this.size = new Vector(1, 1);
  if (ch == "f"){
    this.speed = new Vector(2, 2);
...
/*
Banana.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
...
/*
Falling.prototype.act = function(step, level) {
    var newPos = this.pos.plus(this.speed.times(step));
    if(!level.obstacleAt(newPos, this.size))
      this.pos = newPos;
    else if (this.repeatPos)
...
Level.prototype.playerTouched = function(type, actor) {
  ...
  if (type == "lava" && this.status == null) {
    ...
    this.player.pos = new Vector (49, 44);
  } else if (type == "tele2") {
    this.player.pos = new Vector (84, 23);
  } else if (type == "tele3") {
    this.player.pos = new Vector (9, 25);
  } else if (type == "tele4") {
    this.player.pos = new Vector (13, 40);
  } else if (type == "tele5") {
    this.player.pos = new Vector (50, 29);
  } else if (type == "tele6") {
    this.player.pos = new Vector (81, 40);
  } else if (type == "coin") {
